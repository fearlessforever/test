...
(function( $ ){
	$.fn.easyTable = function (options) {
	   ...
	   this.paging =function(){
		  ...
		  table.append('<ul class="pagination pull-right"><li class="disabled"><a href="#" data-info="prev"> Previous </a></li><li class="active"><a href="#" data-info="cnt">1</a></li><li><a href="#" data-info="next">Next </a></li></ul>');
