...
<header class="navbar" id="header-navbar">
	<div class="container">
	  <a href="<?php echo $__current; ?>" id="logo" class="navbar-brand">
		<img src="<?php echo $__tema; ?>img/logo.png" alt="" class="normal-logo logo-white"/>
		<img src="<?php echo $__tema; ?>img/logo-black.png" alt="" class="normal-logo logo-black"/>
		<img src="<?php echo $__tema; ?>img/logo-small.png" alt="" class="small-logo hidden-xs hidden-sm hidden"/>
	  </a>
		<div class="clearfix">
		...
		<div class="nav-no-collapse pull-right" id="header-nav">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="hidden-xs"><a><span class="timer"><i class="fa fa-clock-o"></i> <span id="clock"></span></span></a></li>
<?php /* <li class="dropdown hidden-xs">
				...
				<li class="dropdown profile-dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img title="<?php echo User::$data['nama']; ?>" src="<?php echo (isset(User::$data['extra']['folder']) && isset(User::$data['extra']['profile_pic']) )? $asset . User::$data['extra']['folder'] . User::$data['extra']['profile_pic'] .'?_='.time() : $asset .'upload/no_image.jpg' ; ?>" alt=""/>
